...
export const SimulatorRenderer = (function () {
    function SimulatorRenderer (canvas, wgl, projectionMatrix, camera, gridDimensions, onLoaded, settings) {
        this.canvas = canvas;
        this.wgl = wgl;
    ...
    SimulatorRenderer.prototype.update = function (timeStep) {
        ...
        if (delayVelosityImitate > 5 && delayVelosityImitate < 10){
            this.mouseX = Math.random() * 1.4 - 0.7;
            this.mouseY = -0.45;
            mouseVelocityX = 50;
            mouseVelocityY = Math.random() * 100 - 50;
            delayVelosityImitate = 0;
        }
