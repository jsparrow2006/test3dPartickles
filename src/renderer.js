...
export const Renderer = (function () {
    ...
    function Renderer (canvas, wgl, gridDimensions, onLoaded, settings) {
        ...
        var midpoint = [gridDimensions[0] / 4, gridDimensions[1] / 4, gridDimensions[2] / 4];
    ...
    Renderer.prototype.draw = function (simulator, projectionMatrix, viewMatrix) {
        ...
        var compositeDrawState = wgl.createDrawState()
            ...
            .uniform2f('u_resolution', this.canvas.width, this.canvas.height)
            .uniform1f('u_fov', fov)
            .uniform3f('u_color1', this.color1.r, this.color1.g, this.color1.b)
            .uniform3f('u_color2', this.color2.r, this.color2.g, this.color2.b)
